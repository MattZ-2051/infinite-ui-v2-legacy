...
<div class="container mt-24 mb-24 lg:mb-0 px-6">
  ...
  <div class="flex justify-center">
    ...
    >
      <div
        style="max-height:50em; min-height:35em"
        class="max-w-7xl px-6 md:px-16 py-2 md:pt-6 lg:pt-12 md:w-1/2 h-2/3 sm:h-full w-full flex flex-col justify-center "
      >
        {#each infoWithId as el, index}
          ...
          >
            <div>
              {#each el.text.split('-').slice(1) as line}
