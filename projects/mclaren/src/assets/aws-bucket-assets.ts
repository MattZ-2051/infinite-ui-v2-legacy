const baseBucketUrl = 'https://mclaren-assets.infiniteworld.com';

const bucketAssets = {
  landing: {
    hero: baseBucketUrl + '/assets-web/749580611251840298msoAnimationVP9_1M.webm',
    ...
    comingSoon: baseBucketUrl + '/assets-web/FINAL_Collections001digital_dynamics_s.mp4',
