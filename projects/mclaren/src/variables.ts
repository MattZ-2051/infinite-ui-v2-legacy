...
export const CLIENT_DOC_TITLE = 'McLaren NFT Collection - Buy Rare & Exclusive Supercar NFTs';
export const CLIENT_DOC_DESCRIPTION =
  'McLaren Genesis NFT collection. Unlock MSO LAB member benefits through an exclusive, invitation-only NFT mint centred around McLaren P1™.';
...
export const CLIENT_API_HEADER: 'aria' | 'mclaren' | 'infinite' | 'seva' = 'mclaren';
