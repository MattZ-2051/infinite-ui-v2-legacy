...
export const MP_HERO_DESCRIPTION_1 =
  'We think scientific literacy flows out of how many science facts can you recite\n' +
  "      rather than how was your brain wired for thinking. And it's the brain wiring that\n" +
  "      I'm more interested in rather than the facts that come out of the curriculum or the\n" +
  "      lesson plan that's been proposed by somebody else.";
export const MP_HERO_DESCRIPTION_2 = "Everything we do, every thought we've ever had, is";
export const MP_HERO_DESCRIPTION_2_HIGHLIGHT = 'produced by the human brain.';
export const MP_HERO_DESCRIPTION_3 = 'How it operates remains one of the';
export const MP_HERO_DESCRIPTION_3_HIGHLIGHT = 'biggest unsolved mysteries';
export const MP_HERO_DESCRIPTION_3_1 = ', and it seems the more we probe its secrets, the more surprises we find.';
export const MP_MINT_TITLE = 'Mint your lifetime access';
export const MP_MAX_SUPPLY = 1000;
...
export const MP_CONTRACT_ADDRESS = '0xa904eDC58E81eC9AE774f73FA01171B852221Ab3';
